    ...
    <!-- Content -->
      ...
      <!-- Button -->
              <div class="mb-5 mb-md-0" data-toggle="animation" data-animation="fadeUp" data-animation-order="3" data-animation-trigger="load">
                <a href = "mailto: Renhousingsolutions@gmail.com?subject=Inquiring About Housing Solutions&body=I am interested in learning more about your mid term rentals!" target="_blank" class="btn btn-outline-primary text-white">
                  Email to inquire
                </a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <!-- Heading -->
            <h3 class="mb-4">
              Want to talk <span class="text-primary">in person</span>? Text us or visit us
            </h3>

            <!-- Subheading -->
            <p class="text-muted mb-5">
              We would love to accomodate your furnished housing needs!
            </p>
